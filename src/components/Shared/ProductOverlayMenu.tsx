...
const ProductOverlayMenu = ({ isOpen, onClose }: ProductOverlayMenuProps) => {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
          className="fixed top-0 inset-0 z-[100] backdrop-blur"
        ...
        >
          <HeroBackground overlayOpacity="99" disablePointerEvents={false}>
            ...
            {/* Content */}
            <div
              className="relative z-10 h-screen backdrop-blur-lg max-h-screen overflow-y-scroll overflow-x-hidden px-6 sm:px-12 lg:px-24 py-24"
            >
              {/* Header */}
              <motion.div
              ...
              >
                <p className="text-white/30 text-sm">
                  Empowering education through technology. Made with love in Cambodia.
                </p>
              </motion.div>
            </div>
          </HeroBackground>
