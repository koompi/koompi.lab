        ...
        {school.status === 'none' || school.fundedPercentage < 100 ? (
          <div className="mb-4">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                className="progress-bar bg-gradient-to-r from-koompi-primary to-koompi-accent-pink h-2 rounded-full transition-all duration-1000"
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 text-koompi-accent-pink text-sm">
