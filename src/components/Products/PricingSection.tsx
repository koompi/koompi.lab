  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
          ...
          <ul className="space-y-2 mb-6 text-sm text-gray-600">
            <li className="flex items-center gap-2">
              <svg className="w-4 h-4 text-koompi-accent-persimmon flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-gradient-to-br from-koompi-accent-persimmon to-pink-400 rounded-xl flex items-center justify-center">
          ...
          <a
            href="/onelab#pricing"
            className="block w-full py-3 bg-gradient-to-r from-koompi-accent-persimmon to-pink-400 text-white text-center rounded-xl font-semibold hover:from-pink-600 hover:to-pink-500 transition-colors"
          >
            Get Content Server
          </a>
        </div>
      ...
      <div className="bg-gradient-to-r from-koompi-primary to-koompi-primary rounded-2xl p-8 text-white">
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <Link
            to="/contact"
            className="px-6 py-3 bg-koompi-accent-persimmon text-white rounded-full font-semibold hover:bg-pink-700 transition-colors whitespace-nowrap border-2 border-accent-500"
          >
          ...
          {POPULAR_CONFIGS.map((config, i) => (
            <div
              ...
              className={`flex items-center justify-between p-4 rounded-xl ${
                config.popular
                  ? 'bg-koompi-accent-persimmon/5 border-2 border-koompi-accent-persimmon/30'
            ...
            >
              <div className="flex items-center gap-3">
                ...
                {config.popular && (
                  <span className="px-2 py-0.5 bg-koompi-accent-persimmon text-white text-xs rounded-full font-medium">
                    Most Popular
                  </span>
                )}
              </div>
