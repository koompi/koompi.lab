        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              { step: '02', title: 'Fund Equipment', desc: 'Choose a lab, content server, or complete package to fund.', icon: '💡' },
              { step: '03', title: 'We Install', desc: 'Our team handles delivery, setup, and teacher training.', icon: '🔧' },
              { step: '04', title: 'Students Learn', desc: 'Students access digital education immediately.', icon: '🎓' },
            ].map((item, i) => (
