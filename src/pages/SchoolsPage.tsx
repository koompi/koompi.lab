        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              Schools Across <span className="text-koompi-accent-persimmon">Cambodia</span>
            </h1>
          ...
          <div className="max-w-2xl mx-auto mb-12">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-koompi-accent-persimmon focus:border-transparent transition-all"
              />
              {searchQuery && (
                <button
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-6 py-4 min-w-[140px]">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-koompi-accent-persimmon/20 rounded-xl flex items-center justify-center">
                  <svg className="w-5 h-5 text-koompi-accent-persimmon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
