      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-koompi-accent-persimmon/5 to-koompi-accent-blue/5 rounded-2xl p-8 border border-koompi-accent-persimmon/10">
              ...
              <div className="flex gap-6">
                <div className="text-center">
                  <p className="text-3xl font-bold text-koompi-accent-persimmon">100%</p>
                  <p className="text-xs text-gray-500">Offline capable</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-koompi-accent-persimmon">15W</p>
                  <p className="text-xs text-gray-500">Per station</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-koompi-accent-persimmon">2TB</p>
              ...
              <div className="grid grid-cols-4 gap-8">
                {HOW_IT_WORKS_STEPS.map((step) => (
                  <div key={step.step} className="relative text-center">
                    <div className="w-16 h-16 mx-auto bg-gradient-to-br from-koompi-accent-persimmon to-pink-400 rounded-full flex items-center justify-center text-white text-2xl font-bold relative z-10 shadow-lg shadow-pink-500/20">
                      {step.step}
                    </div>
                    <div className="mt-6">
            ...
            {HOW_IT_WORKS_STEPS.map((step) => (
              <div key={step.step} className="flex gap-4">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-koompi-accent-persimmon to-pink-400 rounded-full flex items-center justify-center text-white font-bold shadow-lg flex-shrink-0">
                    {step.step}
                  </div>
      ...
      <section id="pricing" className="py-20 px-4 bg-cream">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center">
            <Link
              to="/fund"
              className="group relative inline-flex items-center gap-3 px-12 py-6 bg-gradient-to-r from-koompi-accent-persimmon to-pink-400 text-white rounded-2xl font-semibold text-lg hover:shadow-2xl hover:shadow-pink-500/30 hover:-translate-y-1 transition-all duration-300 hover:scale-105 active:scale-95"
            >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              ...
              <Link
                to="/contact"
                className="inline-block mt-4 px-8 py-4 bg-gradient-to-r from-koompi-accent-persimmon to-pink-400 text-white rounded-full font-semibold hover:shadow-2xl hover:shadow-pink-500/30 hover:-translate-y-1 transition-all duration-300"
              >
