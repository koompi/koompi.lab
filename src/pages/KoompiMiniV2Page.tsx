    ...
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
                KOOMPI Mini
                <span className="text-koompi-accent-persimmon"> V2</span>
              </h1>
              <div className="text-4xl md:text-5xl font-black text-koompi-accent-persimmon mb-4">
                $279
              </div>
                  ...
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      index === currentImageIndex
                        ? 'bg-koompi-accent-persimmon w-8'
                        : 'bg-gray-300'
                    }`}
                  />
                ))}
      ...
      <section className="min-h-screen py-16 md:py-32 bg-cream overflow-hidden flex items-center">
        <div className="container mx-auto px-4 max-w-full">
          <div className="text-center mb-10 md:mb-16 px-2 aos-init" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-12 gap-6 md:gap-8 items-center max-w-6xl mx-auto">
            ...
            <div className="md:col-span-4 grid grid-cols-1 gap-2 md:gap-4 aos-init" data-aos="fade-right">
            ...
            <div className="md:col-span-8 aos-init" data-aos="fade-left">
